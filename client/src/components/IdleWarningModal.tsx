...
export default function IdleWarningModal({ secondsLeft, onStay }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-border p-8 max-w-sm w-full mx-4 text-center">
        ...
        <p className="text-3xl font-bold text-amber-600 dark:text-amber-400 my-3 tabular-nums">{label}</p>
