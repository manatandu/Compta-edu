  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correction: "En SYSCOHADA, la subvention est créditée au compte 14 (sous-compte 1417, organismes internationaux) par le débit du 4582, et reprise au compte 799 à raison de 60 000 × 300 000 / 900 000 = 20 000 par an. Le solde de 280 000 figure fin N parmi les « autres capitaux propres ». IAS 20 écartant l'inscription en capitaux propres (§ 12 et 15), le retraitement IFRS reclasse les 280 000 en produits différés (ou en déduction de l'actif) : les capitaux propres IFRS sont inférieurs de 280 000, et la différence temporelle correspondante est analysée au regard d'IAS 12 (chapitre 6).",
      },
      {
        num: 4,
