...
const SECTIONS: Chapitre['sections'] = [
  {
    ...
    blocs: [
      ...
      { type: 'carte', titre: "Tableau 1.1 — Chronologie des textes applicables aux sociétés en RDC", tableau: { entetes: ['Date', 'Événement', 'Portée pour les sociétés'], lignes: [
  ...
  },
  {
    ...
    blocs: [
      ...
      { type: 'carte', titre: "Tableau 1.2 — Les éléments constitutifs de la société", tableau: { entetes: ['Élément', 'Fondement', 'Ce qui le distingue d\'une figure voisine'], lignes: [
  ...
  },
  {
    ...
    blocs: [
      { type: 'intertitre', texte: "1.3.1 Pluralité d'associés et associé unique" },
      ...
      { type: 'intertitre', texte: "1.3.3 Interdictions, incompatibilités et incapacités" },
      ...
      { type: 'carte', titre: "Tableau 1.4 — La capacité requise selon la forme sociale", tableau: { entetes: ['Personne', 'SNC', 'SCS', 'SARL', 'SA / SAS'], lignes: [
  ...
  },
  {
    ...
    blocs: [
      ...
      { type: 'intertitre', texte: "1.4.1 L'apport en numéraire" },
      ...
      { type: 'intertitre', texte: "1.4.2 L'apport en nature et son évaluation" },
      ...
      { type: 'intertitre', texte: "1.4.3 L'apport en industrie" },
      { type: 'carte', titre: "Encadré 1.1 — L'apport en industrie depuis la révision de 2014 (art. 50-1 à 50-4)", liste: [
      ...
      { type: 'paragraphe', texte: "L'apport en industrie répond à une situation fréquente dans les jeunes entreprises : un ingénieur, un informaticien ou un technicien expérimenté apporte son savoir-faire à des associés qui apportent l'argent. Ses droits ne concourent pas à la formation du capital : le capital est le gage des créanciers, et un savoir-faire ne peut être saisi ni vendu pour les désintéresser ; l'inclure dans le capital afficherait une solidité fictive. Le double plafond de 25 % empêche que l'apporteur en industrie, qui ne risque aucun bien, ne prenne le contrôle de la société au détriment de ceux qui ont risqué leur argent. Les titres sont incessibles parce que l'apport est attaché à la personne : si l'apporteur cessait son activité ou cédait ses titres, la contrepartie disparaîtrait. L'apporteur doit enfin compte à la société de tous les gains réalisés par l'activité faisant l'objet de son apport : l'ingénieur qui apporte son expertise en géologie minière ne peut pas conserver pour lui les honoraires de missions qu'il réaliserait à titre personnel dans ce même domaine." },
    ],
  },
  {
    numero: '1.5',
    ...
    blocs: [
      ...
      { type: 'carte', titre: "Tableau 1.5 — Les limites de la liberté statutaire", tableau: { entetes: ['Stipulation', 'Validité', 'Fondement'], lignes: [
      ...
      { type: 'intertitre', texte: "1.5.3 La circulation et l'évaluation des titres" },
  ...
  },
  {
    ...
    blocs: [
      ...
      { type: 'intertitre', texte: "1.6.1 Le montant du capital et le choix congolais" },
  ...
  },
  {
    ...
    blocs: [
      { type: 'intertitre', texte: "1.7.1 La forme des statuts et leurs mentions obligatoires" },
      ...
      { type: 'carte', titre: "Encadré 1.2 — Les treize mentions obligatoires des statuts (art. 13)", liste: [
      ...
      { type: 'intertitre', texte: "1.7.2 La dénomination et l'objet social" },
      ...
      { type: 'intertitre', texte: "1.7.3 Le siège social et la durée" },
  ...
  },
  {
    ...
    blocs: [
      { type: 'intertitre', texte: "1.8.1 La commercialité par la forme et par l'objet" },
      ...
      { type: 'carte', titre: "Tableau 1.6 — Les cinq formes sociales, étudiées aux chapitres 3 à 6", tableau: { entetes: ['Forme', 'Définition légale', 'Responsabilité', 'Capital minimum', 'Associés'], lignes: [
      ...
      { type: 'intertitre', texte: "1.8.2 Le choix de la forme sociale" },
      ...
      { type: 'intertitre', texte: "1.8.3 La succursale et le bureau de représentation" },
  ...
  },
  {
    ...
    blocs: [
      ...
      { type: 'carte', titre: "Tableau 1.7 — La reprise des engagements pris avant l'immatriculation", tableau: { entetes: ['Période et situation', 'Mode de reprise', 'Article'], lignes: [
      ...
      { type: 'intertitre', texte: "1.9.2 La déclaration de régularité et l'immatriculation" },
      ...
      { type: 'intertitre', texte: "1.9.3 Le Guichet unique de création d'entreprise" },
      ...
      { type: 'carte', titre: "Encadré 1.3 — La procédure de création d'une personne morale au GUCE (décret n° 14/014, art. 16, B)", liste: [
  ...
  },
  {
    ...
    blocs: [
      { type: 'intertitre', texte: "1.10.1 Les pactes d'associés" },
      ...
      { type: 'carte', titre: "Tableau 1.8 — Les clauses courantes des pactes d'associés", tableau: { entetes: ['Clause courante', 'Objet', 'Rattachement à l\'art. 2-1'], lignes: [
      ...
      { type: 'intertitre', texte: "1.10.2 La nullité de la société et sa régularisation" },
      ...
      { type: 'carte', titre: "Tableau 1.9 — Le régime de la nullité de la société (art. 246 à 255)", tableau: { entetes: ['Règle', 'Contenu', 'Article'], lignes: [
      ...
      { type: 'intertitre', texte: "1.10.3 La responsabilité des fondateurs et des premiers dirigeants" },
