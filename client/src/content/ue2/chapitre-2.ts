...
const SECTIONS: Chapitre['sections'] = [
  {
    ...
    blocs: [
      ...
      { type: 'carte', titre: "Quel système comptable pour quelle entité ?", tableau: { entetes: ['Système', 'Entités concernées', 'États à produire', 'Texte'], lignes: [
  ...
  },
  {
    ...
    blocs: [
      ...
      { type: 'carte', titre: "Écritures d'affectation dans le SYSCOHADA", tableau: { entetes: ['Opération', 'Débit', 'Crédit'], lignes: [
  ...
  },
  {
    ...
    blocs: [
      { type: 'filet', titre: "Article 143 al. 1 AUSCGIE", texte: "« Le bénéfice distribuable est le résultat de l'exercice, augmenté du report bénéficiaire et diminué des pertes antérieures, des dividendes partiels régulièrement distribués ainsi que des sommes portées en réserve en application de la loi ou des statuts. »" },
      ...
      { type: 'carte', titre: "Exemple chiffré : la SARL KASAI BOIS (exercice 2025, en francs congolais)", tableau: { entetes: ['Élément', 'Montant', 'Commentaire'], lignes: [
  ...
  },
  {
    ...
    blocs: [
      ...
      { type: 'carte', titre: "Formalités de publicité au cours de la vie sociale", tableau: { entetes: ['Événement', 'Formalités', 'Délai', 'Texte'], lignes: [
  ...
  },
  {
    ...
    blocs: [
      ...
      { type: 'tableau', tableau: { entetes: ['Règle', 'Contenu', 'Article'], lignes: [
  ...
  },
  {
    ...
    blocs: [
      ...
      { type: 'carte', titre: "Le cycle financier annuel d'une société : grille de contrôle", tableau: { entetes: ['Étape', 'Question à se poser', 'Texte'], lignes: [
      ...
      { type: 'paragraphe', texte: "Ce chapitre a montré que le droit des sociétés et le droit comptable forment, pour la vie financière de la société, un ensemble indissociable. Le droit comptable dit comment mesurer le résultat ; le droit des sociétés dit qui en décide, dans quelles limites et avec quelles garanties pour les créanciers. Les chapitres suivants étudieront les règles propres à chaque forme sociale, en commençant par les sociétés de personnes ; la grille ci-dessus s'appliquera à chacune d'elles, avec les adaptations propres à la SNC, où la responsabilité illimitée des associés rend la question du bénéfice distribuable moins vitale pour les créanciers, et à la SA, où la présence du commissaire aux comptes et d'actionnaires nombreux rend au contraire chaque étape plus formelle." },
