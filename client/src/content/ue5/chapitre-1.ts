...
const SECTIONS: Chapitre['sections'] = [
  {
    ...
    blocs: [
      { type: 'intertitre', texte: "1.1.1 Définition et texte fondateur" },
      ...
      { type: 'paragraphe', texte: "La doctrine éclaire ce que recouvre ce droit. Dans son ouvrage classique, Jacques Magnet définit la comptabilité publique comme l'ensemble des règles juridiques et techniques applicables à l'exécution, à la description et au contrôle des opérations financières des organismes publics. Il souligne que cette comptabilité reste dominée par l'**autorisation budgétaire préalable**, et non par la recherche d'un résultat comme la comptabilité d'entreprise. La distinction commande la suite du cours. Dans une société commerciale, le dirigeant engage librement une dépense qu'il juge rentable, et la comptabilité en mesure ensuite l'effet sur le bénéfice. Dans l'État, aucune dépense n'est possible sans une autorisation votée, dans la limite d'un crédit, et sans l'intervention de deux agents distincts : l'ordonnateur, qui décide, et le comptable public, qui paie. Le droit des finances publiques organise donc moins la mesure d'une performance que la **légalité** et la **traçabilité** de chaque franc public." },
      { type: 'intertitre', texte: "1.1.2 Le champ d'application et les définitions" },
      ...
      { type: 'carte', titre: "Tableau 1.1 — Finances publiques et finances privées", tableau: { entetes: ['Critère', 'Finances publiques', 'Finances privées'], lignes: [
      ...
      { type: 'intertitre', texte: "1.1.3 De la loi financière de 1983 à la LOFIP" },
      { type: 'paragraphe', texte: "La LOFIP est née d'un constat sévère, que son exposé des motifs formule sans détour : « La gestion des finances publiques congolaises s'effectue actuellement dans un cadre juridique et institutionnel totalement inadapté au contexte de la Constitution du 18 février 2006, prônant notamment la libre administration des provinces et la décentralisation. » Le texte alors en vigueur, la loi financière n° 83-003 du 23 février 1983, modifiée par l'ordonnance-loi n° 87-004 du 10 janvier 1987, avait été conçu pour un État centralisé ; il ignorait les provinces dotées de finances distinctes et les entités territoriales décentralisées que la Constitution de 2006 venait d'instituer. La réforme devait aussi formaliser les pratiques introduites depuis 2002 dans la chaîne de la dépense, le report des crédits et les nomenclatures budgétaires." },
      { type: 'carte', titre: "Encadré 1.1 — Les innovations annoncées par l'exposé des motifs de la LOFIP", texte: "L'exposé des motifs présente la loi comme caractérisée par les « innovations majeures » suivantes :", liste: [
      ...
      ], note: "Chacune de ces innovations fait l'objet d'un chapitre du module : principes budgétaires (chapitre 2), structure du budget (chapitre 3), budget-programme (chapitre 4), trésorerie (chapitre 6) et décentralisation (chapitre 8)." },
      { type: 'paragraphe', texte: "La réforme ne s'est pas appliquée d'un coup. La loi n° 18/010 du 9 juillet 2018 a rendu les dispositions relatives au budget-programme « applicables de façon progressive à dater de la promulgation de la présente loi » et prorogé de cinq ans le délai d'application intégrale de la LOFIP. La loi n° 23/030 du 28 juin 2023 a prorogé ce délai une seconde fois de cinq ans ; son exposé des motifs reconnaît que, douze ans après 2011, le passage au budget-programme restait tributaire de réformes transversales : comptabilité publique, cadres organiques, déconcentration de l'ordonnancement et système d'information. Elle impose en outre au Ministre du Budget de présenter chaque année à l'Assemblée nationale, au cours de la session budgétaire, « un rapport décrivant les progrès vers la mise en œuvre effective de la réforme du budget-programme » (art. 234 nouveau). Conséquence pratique : la loi financière de 1983 n'est abrogée qu'à l'échéance ainsi prorogée, et elle continue de régir les ministères, institutions, provinces et ETD que la loi de finances de l'année n'a pas encore fait entrer dans le nouveau régime." },
    ],
  },
  {
    numero: '1.2',
    ...
    blocs: [
      { type: 'intertitre', texte: "1.2.1 Les règles de structure" },
      ...
      { type: 'carte', titre: "Tableau 1.2 — Les articles financiers de la Constitution, dans leur texte exact", tableau: { entetes: ['Article', 'Ce qu\'il dit réellement'], lignes: [
      ...
      { type: 'intertitre', texte: "1.2.2 La légalité de l'impôt et le devoir contributif" },
      { type: 'paragraphe', texte: "L'article 174 de la Constitution énonce trois règles : « Il ne peut être établi d'impôts que par la loi. La contribution aux charges publiques constitue un devoir pour toute personne vivant en République Démocratique du Congo. Il ne peut être établi d'exemption ou d'allègement fiscal qu'en vertu de la loi. » La première et la troisième règle traduisent le **consentement à l'impôt** par les représentants de la Nation : ni le Gouvernement, ni une assemblée provinciale, ni une administration fiscale ne peuvent créer un prélèvement ou en dispenser un contribuable. La LOFIP les reprend à son article 9, et chaque loi de finances les rappelle : la loi de finances pour 2026 énonce elle-même, dans ses dispositions générales, qu'aucune exonération ni aucun allégement fiscal ne peut être établi que par une loi. La deuxième règle, le devoir contributif, fonde l'obligation de toute personne vivant en RDC, nationale ou étrangère, de contribuer aux charges publiques." },
      { type: 'intertitre', texte: "1.2.3 Les institutions financières de la Constitution" },
      { type: 'paragraphe', texte: "La Constitution institue ensuite trois organes financiers. La **Banque centrale du Congo** est l'institut d'émission ; parmi ses missions figure « la garde des fonds publics » (art. 176), ce qui explique que le compte général du Trésor et les comptes uniques des provinces et des ETD soient ouverts dans ses livres. Elle est indépendante et jouit de l'autonomie de gestion, et la LOFIP interdit en conséquence au pouvoir central, aux provinces et aux ETD tout recours à ses avances (art. 16). La **Cour des comptes** « relève de l'Assemblée nationale » (art. 178) ; elle contrôle la gestion des finances de l'État, des biens publics et les comptes des provinces, des ETD et des organismes publics, et publie chaque année un rapport remis au Président de la République, au Parlement et au Gouvernement, lui-même publié au Journal officiel (art. 180). La **Caisse nationale de péréquation**, enfin, est chargée de la solidarité financière entre territoires (art. 181), étudiée à la section 1.4." },
    ],
  },
  {
    numero: '1.3',
    ...
    blocs: [
      { type: 'intertitre', texte: "1.3.1 Trois étages, trois actes budgétaires" },
      { type: 'carte', titre: "Tableau 1.3 — Pouvoir central, provinces et ETD", tableau: { entetes: ['Étage', 'Acte budgétaire', 'Organe qui vote', 'Ressources principales'], lignes: [
      ...
      { type: 'intertitre', texte: "1.3.2 Intégration et consolidation" },
      ...
      { type: 'carte', titre: "Exemple 1.1 — Les ordres de grandeur du budget 2026", tableau: { entetes: ["Grandeur", "Montant (FC)", "Loi de finances n° 25/060"], lignes: [
        ["Budget du pouvoir central, en équilibre (budget général, budgets annexes et comptes spéciaux)", "54 335 751 192 461", "art. 6"],
        ["dont budget général", "48 969 279 573 100", "art. 7 et annexe I"],
        ["dont budgets annexes", "962 258 869 270", "annexe I"],
        ["dont comptes spéciaux", "4 404 212 750 090", "annexe I"],
        ["Part des recettes à caractère national allouée aux provinces", "7 694 540 952 980", "art. 8"],
        ["Ressources de la Caisse nationale de péréquation", "744 632 995 450", "art. 9"],
      ] }, note: "Le budget de l'État au sens de l'art. 6 de la LOFIP n'apparaît qu'après la loi de consolidation, qui agrège ces montants avec les budgets provinciaux. La loi de finances de l'année ne vote que le budget du pouvoir central et fixe la part des provinces." },
    ],
  },
  {
    numero: '1.4',
    ...
    blocs: [
      { type: 'intertitre', texte: "1.4.1 Le principe constitutionnel des 40 %" },
      ...
      { type: 'carte', titre: "Tableau 1.4 — Les catégories A et B de recettes à caractère national (art. 219-221 LOFIP)", tableau: { entetes: ['Catégorie', 'Contenu', 'Mécanisme des 40%'], lignes: [
      ...
      { type: 'intertitre', texte: "1.4.2 La péréquation" },
      ...
      { type: 'paragraphe', texte: "Les montants varient fortement d'un exercice à l'autre : la loi de finances 2025 avait doté la Caisse de 2 376,5 milliards FC (art. 10), celle de 2026 de 744,6 milliards FC (art. 9). La Constitution fixe pourtant un taux, 10 % de la totalité des recettes à caractère national revenant à l'État. L'écart invite à vérifier, dans les annexes de chaque loi de finances, l'assiette retenue pour ce calcul et la part effectivement transférée. Pour l'analyste, la péréquation est un test de cohérence entre la règle constitutionnelle et l'autorisation budgétaire annuelle." },
      { type: 'intertitre', texte: "1.4.3 La part des entités territoriales décentralisées" },
      { type: 'paragraphe', texte: "Les ETD ont droit à **40% de la part des recettes à caractère national allouées aux provinces** - conformément à l'art. 115 de la loi organique n° 08/016 sur les ETD - ainsi qu'à **40% des impôts et taxes provinciaux d'intérêt commun** (Art. 225 LOFIP). La répartition entre ETD se fait selon la capacité contributive, la superficie et le poids démographique (Art. 226)." },
      { type: 'carte', titre: "Exemple 1.2 — La retenue à la source dans une province génératrice (montants fictifs)", tableau: { entetes: ["Étape", "Calcul", "Montant (milliards FC)"], lignes: [
        ["Recettes à caractère national recouvrées dans la province au cours du mois", "", "1 000"],
        ["Part de la province, créditée à son compte lors du nivellement (art. 175 Constitution ; art. 3 et 218 LOFIP)", "1 000 × 40 %", "400"],
        ["Montant nivelé au profit du compte général du Trésor", "1 000 − 400", "600"],
        ["Part revenant aux ETD de la province (art. 225 LOFIP)", "400 × 40 %", "160"],
        ["Part conservée par la province", "400 − 160", "240"],
      ] }, note: "Les 160 sont répartis entre les ETD selon la capacité contributive, la superficie et le poids démographique (art. 226). Si des compétences n'ont pas été effectivement transférées, le pouvoir central peut retenir sur la quote-part provinciale le coût correspondant, dans les conditions fixées par une loi de finances (art. 218) : les 400 constituent donc un maximum." },
    ],
  },
  {
    numero: '1.5',
    ...
    blocs: [
      { type: 'intertitre', texte: "1.5.1 Les deux ministres financiers" },
      { type: 'carte', titre: "Tableau 1.5 — Le Ministre du Budget et le Ministre des Finances dans la LOFIP", tableau: { entetes: ['Ministre', 'Attributions textuelles', 'Articles'], lignes: [
      ...
      { type: 'intertitre', texte: "1.5.2 Ordonnateurs, comptables et contrôleurs budgétaires" },
      ...
      { type: 'paragraphe', texte: "La loi de finances pour 2026 montre que cette architecture reste en construction. Son article 5 accélère la **déconcentration de l'ordonnancement** prévue à l'article 103 de la LOFIP, en désignant neuf ministères pilotes, dont les Finances, la Santé, l'Éducation, les Infrastructures et la Défense ; dans ces ministères, le ministre ordonnateur ordonnance lui-même ses dépenses. Pour les autres, la même loi maintient un **régime transitoire** : le Ministre du Budget liquide les dépenses par un visa préalable et le Ministre des Finances les ordonnance (art. 84), ce dernier transmettant chaque jour au Ministre du Budget la situation des encaissements et des décaissements (art. 85). Tant que la réforme n'est pas achevée, l'étudiant doit donc distinguer le schéma cible de la LOFIP et le schéma effectivement appliqué." },
      { type: 'intertitre', texte: "1.5.3 L'actualité : la Direction générale du Trésor et de la Comptabilité publique" },
      { type: 'paragraphe', texte: "Le réseau des comptables publics est, lui aussi, en voie de réorganisation. La Direction générale du Trésor et de la Comptabilité publique (DGTCP), prévue par la LOFIP, créée par décret en 2022 puis réorganisée par le décret n° 24/15 du 14 octobre 2024, a déployé son personnel, ses directions et ses postes comptables entre juin et août 2025. Le 29 janvier 2026, les comptables publics principaux et secondaires affectés aux ministères pilotes ont prêté serment à Kinshasa ; la DGTCP présentait alors la phase pilote comme couvrant quatre postes comptables et les opérations de sept ministères, et la cérémonie s'inscrivait dans les engagements pris envers le FMI dans le cadre de la Facilité élargie de crédit. Le 19 février 2026, le ministre des Finances a présidé la cérémonie marquant l'opérationnalisation de la DGTCP, quatorze ans après l'adoption de la LOFIP. L'écart entre les neuf ministères désignés par la loi de finances et les sept couverts par la phase pilote annoncée rappelle qu'une réforme se lit à la fois dans les textes et dans leur mise en œuvre." },
      { type: 'intertitre', texte: "1.5.4 Responsabilités et sanctions" },
      { type: 'carte', titre: "Encadré 1.2 — Les sanctions du régime financier (art. 128-131 LOFIP)", liste: [
  ...
  },
  {
    ...
    blocs: [
      { type: 'intertitre', texte: "1.6.1 Les quatre catégories de lois de finances" },
      ...
      { type: 'intertitre', texte: "1.6.2 La loi de finances pour 2026" },
      { type: 'carte', titre: "Tableau 1.6 — La loi de finances n° 25/060 du 29 décembre 2025 (exercice 2026)", tableau: { entetes: ['Grandeur', 'Montant', 'Article'], lignes: [
      ...
      { type: 'carte', titre: "Tableau 1.7 — Les hypothèses macroéconomiques des lois de finances 2025 et 2026", tableau: { entetes: ["Indicateur", "LF 2025", "LFR 2025", "LF 2026 (projections)"], lignes: [
        ["Taux de croissance du PIB", "5,7 %", "5,3 %", "5,3 %"],
        ["Taux d'inflation moyen", "10,3 %", "8,8 %", "4,4 %"],
        ["Taux d'inflation en fin de période", "9,2 %", "7,8 %", "6,1 %"],
        ["Taux de change moyen (FC/USD)", "2 954,4", "2 859,2", "2 467,0"],
        ["PIB nominal (milliards FC)", "213 544,4", "239 489,7", "269 291,9"],
      ] }, note: "Source : tableau de cadrage macroéconomique de la loi de finances n° 25/060. L'exposé des motifs projette pour 2026 une pression fiscale de 12,3 %. Toute prévision de recettes dépend de ces hypothèses : un taux de change plus faible que prévu réduit en francs congolais les recettes perçues en dollars, une inflation plus forte gonfle les recettes nominales mais aussi les dépenses." },
      { type: 'carte', titre: "Tableau 1.8 — La structure du budget général 2026", tableau: { entetes: ["Poste", "Montant (milliards FC)", "Part"], lignes: [
        ["Recettes internes", "34 578,9", "70,6 % des recettes"],
        ["dont impôts", "19 033,6", "55,0 % des recettes internes"],
        ["dont douanes et accises", "7 522,0", ""],
        ["dont recettes non fiscales", "6 469,4", ""],
        ["Recettes extérieures (appuis budgétaires, dons et emprunts projets)", "14 390,3", "29,4 % des recettes"],
        ["Dépenses de personnel", "14 033,0", "28,7 % des dépenses"],
        ["Équipements, constructions et réhabilitations", "16 012,5", "32,7 % des dépenses"],
        ["Transferts et interventions de l'État", "8 533,8", "17,4 % des dépenses"],
        ["Dette publique en capital et frais financiers", "2 967,8", "6,1 % des dépenses"],
      ] }, note: "Source : annexes I et II de la loi de finances n° 25/060 ; parts calculées sur le budget général de 48 969,3 milliards FC. Les dépenses de personnel progressent de 31,2 % par rapport à la loi de finances initiale 2025 (10 695,1 milliards FC) et de 16,0 % par rapport à la loi rectificative (12 097,4 milliards FC)." },
      { type: 'paragraphe', texte: "Ces chiffres se lisent avec les principes étudiés au chapitre 2. Près de trois francs sur dix du budget général proviennent de ressources extérieures, dont une large part de dons et d'emprunts affectés à des projets : leur exécution dépend du rythme de décaissement des partenaires, et l'article 10 de la LOFIP interdit d'exécuter une dépense financée sur ressources extérieures tant que les fonds ne sont pas effectivement mobilisés. Les dépenses de personnel, rigides, absorbent plus du quart des crédits. La marge de manœuvre réelle du Gouvernement se situe donc dans les dépenses d'investissement, qui sont aussi les premières à être réduites lorsque les recettes ne suivent pas : entre la loi initiale et la loi rectificative de 2025, les équipements sont passés de 13 915,4 à 11 589,5 milliards FC." },
      { type: 'intertitre', texte: "1.6.3 Les enseignements de la séquence 2025-2026" },
      ...
      { type: 'paragraphe', texte: "L'exécution confirme l'importance de la sincérité. Dans son rapport public annuel portant sur les exercices 2024 et 2025, publié en février 2026, la Cour des comptes a examiné l'exécution de la loi de finances 2023 : le budget avait été voté en équilibre à 32 456,78 milliards FC, mais les recettes réalisées n'ont atteint que 29 607,09 milliards FC, soit un taux de réalisation de 91,22 %, dont 19 832,79 milliards FC de recettes internes. Un budget voté en équilibre peut donc s'exécuter en déséquilibre lorsque les prévisions de recettes sont trop optimistes ; c'est précisément ce que la loi de finances rectificative, le contrôle de la Cour et la loi de reddition des comptes permettent de révéler et de corriger." },
    ],
  },
]
