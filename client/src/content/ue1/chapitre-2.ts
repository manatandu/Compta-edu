// Chapitre 2 du module UE1, Droit du travail : contenu pur.
...
const SECTIONS: Chapitre['sections'] = [
  {
    numero: '2.1',
    titre: 'L\'obligation de formation professionnelle',
    navLabel: '2.1 L\'obligation de formation',
    blocs: [
      { type: 'paragraphe', texte: 'Le Titre II du Code du travail s\'ouvre sur une obligation, non une simple faculté : selon l\'article 8, tout employeur, public ou privé, a l\'obligation d\'assurer la formation, le perfectionnement ou l\'adaptation professionnelle des travailleurs qu\'il emploie. Le Code lui offre pour cela un instrument central, l\'Institut National de Préparation Professionnelle, dont les moyens sont mis à sa disposition sur toute l\'étendue du territoire.' },
      { type: 'paragraphe', texte: 'Cette obligation ne s\'exécute pas dans le vide : elle s\'inscrit dans une politique nationale de la formation et du perfectionnement professionnels, déterminée par décret du Président de la République, pris sur proposition du Ministre du Travail après avis du Conseil National du Travail. Le Ministre en assure ensuite l\'exécution, en élaborant, avec le concours de l\'INPP, des organisations professionnelles et des centres agréés, un programme de préparation professionnelle qui vise cinq objectifs énumérés à l\'article 10 : la création d\'emplois, l\'amélioration de la productivité, la mobilité professionnelle, l\'insertion des jeunes et la réinsertion des accidentés du travail.' },
      { type: 'filet', titre: 'Une obligation de moyens rattachée à une politique d\'État', texte: 'L\'employeur n\'a pas à organiser lui-même un dispositif de formation complet : il doit utiliser les moyens existants, au premier rang desquels l\'INPP, dans le cadre d\'une politique nationale qui dépasse le seul rapport contractuel employeur-travailleur.' },
      { type: 'paragraphe', texte: 'Un partenariat conclu le 23 décembre 2025 entre l\'Association nationale des entreprises du portefeuille de l\'État et l\'INPP illustre la vivacité actuelle de cette politique : il vise à adapter l\'offre de formation aux besoins réels du marché du travail, dans le prolongement des objectifs de l\'article 10, et rappelle que ce Titre II, ancien dans sa rédaction, continue de produire des effets concrets et actuels sur l\'organisation de la formation professionnelle en RDC.' },
    ],
  },
  {
    numero: '2.2',
    titre: 'Statut et gouvernance de l\'Institut National de Préparation Professionnelle',
    navLabel: '2.2 Statut et gouvernance de l\'INPP',
    blocs: [
      { type: 'paragraphe', texte: 'L\'article 11 institue l\'Institut National de Préparation Professionnelle, INPP en sigle, doté de la personnalité juridique, siège à Kinshasa, avec la capacité d\'acquérir des biens meubles et immeubles et d\'en disposer, ses engagements étant garantis par l\'État. Cette personnalité juridique n\'est pas une création ex nihilo du Code de 2002 : l\'article 17 maintient en vigueur les dispositions de l\'ordonnance-loi n°206 du 29 juin 1964, portant création de l\'Institut, dans la mesure où elles ne sont pas contraires au présent Titre, ce qui rattache l\'INPP à une continuité institutionnelle remontant aux premières années de l\'indépendance.' },
      { type: 'paragraphe', texte: 'La mission de l\'INPP, définie à l\'article 12, est large : collaborer à la qualification professionnelle de la population active nationale, par le perfectionnement des travailleurs en emploi, la formation rapide de nouveaux travailleurs adultes, l\'apprentissage dans l\'emploi, la préparation professionnelle et la réadaptation des travailleurs frappés d\'incapacité. L\'article 13 y ajoute des missions plus techniques : coopération entre organismes de formation, participation à l\'établissement de normes de qualification, coopération avec l\'Office National de l\'Emploi sur les tendances du marché du travail, et orientation professionnelle.' },
      { type: 'tableau', tableau: { entetes: ['Organe', 'Rôle'], lignes: [['Ministère du Travail', 'Tutelle technique de l\'État sur l\'Institut'], ['Conseil d\'administration tripartite', 'Organisation générale, administration et gestion, associant État, employeurs et travailleurs']] } },
      { type: 'paragraphe', texte: 'Cette gouvernance tripartite, articulée à l\'article 14, mérite d\'être rapprochée de celle du Conseil National du Travail lui-même, dont l\'avis conditionne plusieurs actes réglementaires étudiés dans ce chapitre : c\'est une même logique de dialogue social institutionnalisé, entre l\'État, les employeurs et les travailleurs, que le Titre II reproduit à l\'échelle de l\'INPP.' },
    ],
  },
  {
    numero: '2.3',
    titre: 'Le financement de l\'INPP : la cotisation patronale',
    navLabel: '2.3 Le financement : la cotisation',
    blocs: [
      { type: 'paragraphe', texte: 'L\'article 15 énumère les ressources de l\'INPP : subvention annuelle de l\'État, apports, dons et legs, rétributions exceptionnelles pour services spéciaux, et surtout, en pratique la plus significative pour les entreprises, la cotisation mensuelle des employeurs, proportionnelle à la somme des rémunérations versées à leur personnel au cours du trimestre précédent. Le Code renvoie la fixation du taux à un arrêté conjoint des Ministres du Travail, des Finances et du Budget, pris après avis du Conseil National du Travail.' },
      { type: 'tableau', tableau: { entetes: ['Catégorie d\'employeur', 'Taux 2006-2025 (abrogé)', 'Taux depuis le 24/09/2025'], lignes: [['Entreprises et établissements publics', '3 %', '4 %'], ['Secteur privé, 1 à 50 travailleurs', '3 %', '3,5 %'], ['Secteur privé, 51 à 300 travailleurs', '2 %', '3 %'], ['Secteur privé, plus de 300 travailleurs', '1 %', '2 %']] } },
      { type: 'paragraphe', texte: 'La révision opérée par l\'arrêté interministériel du 24 septembre 2025, qui abroge celui du 14 février 2006, relève chaque tranche tout en resserrant l\'écart entre petites et grandes structures : en 2006, le taux plein des petites entreprises privées rejoignait celui du secteur public, quand en 2025 un écart d\'un demi-point subsiste entre les deux, tandis que l\'écart entre la plus petite et la plus grande tranche privée se réduit à un point et demi contre deux points auparavant.' },
      { type: 'filet', titre: 'Assiette et comptabilisation', texte: 'La cotisation INPP est assise sur les rémunérations versées, la même assiette que celle étudiée à propos de l\'article 7 au chapitre 1 : les éléments qui en sont exclus, indemnité de logement, allocations familiales légales, échappent également à cette cotisation. En pratique comptable, la dette envers l\'INPP est usuellement enregistrée au compte SYSCOHADA 4331.' },
      { type: 'paragraphe', texte: 'Le taux dépend d\'abord de la nature de l\'employeur, public ou privé, puis, pour le secteur privé, d\'un seuil d\'effectif, jamais d\'un seuil de chiffre d\'affaires ou de rémunération globale : une entreprise qui franchit un seuil d\'effectif en cours d\'exercice change de tranche à compter de ce franchissement, sans attendre la clôture de l\'exercice.' },
    ],
  },
  {
    numero: '2.4',
    titre: 'Forme et preuve du contrat d\'apprentissage',
    navLabel: '2.4 Forme et preuve du contrat',
    blocs: [
      { type: 'paragraphe', texte: 'Le Titre III organise un régime de formation distinct de l\'emploi ordinaire, celui du contrat d\'apprentissage, en commençant par les conditions requises du maître : selon l\'article 18, nul ne peut recevoir des apprentis mineurs s\'il n\'est âgé de dix-huit ans au moins, reconnu de bonne vie et mœurs, et suffisamment qualifié pour donner ou faire donner une formation appropriée. Une protection spécifique s\'y ajoute : aucun maître ne vivant ni en famille ni en communauté ne peut loger comme apprenties des jeunes filles mineures, disposition à laquelle aucun consentement, même parental, ne peut déroger.' },
      { type: 'paragraphe', texte: 'Le formalisme du contrat est strict. L\'article 19 exige un écrit, rédigé dans une langue connue de l\'apprenti, signé par le maître, l\'apprenti et ses parents ou son représentant, exempt de tout droit de timbre et d\'enregistrement. L\'article 20 en fixe les mentions obligatoires : identité complète des parties et du représentant légal de l\'apprenti mineur, date de début et durée, plafonnée à quatre ans quels que soient les usages de la profession, indemnités éventuellement consenties, profession enseignée et cours professionnels que le maître s\'engage à faire suivre.' },
      { type: 'carte', titre: 'Article 21, alinéa 3, Loi n°015/2002', note: '« Tant que le contrat n\'a pas été soumis au visa, ou lorsque le visa a été retiré, les services de l\'apprenti sont présumés être prestés en exécution d\'un contrat de travail respectivement à la date de la conclusion du contrat et du retrait du visa. »' },
      { type: 'paragraphe', texte: 'Cette présomption est la clé de voûte du dispositif : le contrat d\'apprentissage doit être établi en quatre exemplaires au moins et soumis au visa de l\'Office National de l\'Emploi, dont l\'article 22 précise les vérifications, certificat médical d\'aptitude, identité de l\'apprenti, conformité du contrat, absence d\'engagement antérieur ou de qualification exclusive d\'apprentissage. Tant que ce visa n\'a pas été accordé, ou s\'il a été retiré, l\'apprenti bénéficie du régime plus protecteur du contrat de travail, une articulation directe avec les notions de l\'article 7 étudiées au chapitre 1.' },
  ...
  {
    numero: '2.5',
    titre: 'Les obligations réciproques du maître et de l\'apprenti',
    navLabel: 'Obligations réciproques',
    blocs: [
      { type: 'paragraphe', texte: 'Le Titre III organise un échange d\'obligations qui dépasse la seule transmission d\'un savoir-faire. L\'article 24 impose au maître d\'enseigner méthodiquement le métier, de traiter l\'apprenti avec les égards voulus, de veiller à sa sécurité et à sa santé, d\'avertir sans retard les parents en cas de maladie ou de faute grave, de lui accorder un congé annuel, de lui fournir les prestations dues en cas de maladie ou d\'accident, et de lui délivrer, à la fin de l\'apprentissage, un certificat conforme au modèle réglementaire.' },
      { type: 'tableau', tableau: { entetes: ['Obligations du maître (art. 24)', 'Obligations de l\'apprenti (art. 26)'], lignes: [['Enseigner méthodiquement le métier, fournir outils et matériel', 'Se conformer aux ordres du maître ou de son préposé'], ['Traiter l\'apprenti avec les égards voulus, veiller à sa sécurité et sa santé', 'Exécuter les travaux confiés selon ses aptitudes'], ['Avertir sans retard les parents en cas de maladie, absence ou faute grave', 'Observer le respect des convenances et bonnes mœurs'], ['Accorder un congé annuel, verser l\'indemnité prévue', 'Restituer en bon état outils et matériels confiés'], ['Fournir les prestations dues en cas de maladie ou d\'accident', 'Garder les secrets de fabrication ou d\'affaires'], ['Délivrer un certificat de fin d\'apprentissage', 'Se soumettre aux examens médicaux et d\'évaluation']] } },
      { type: 'paragraphe', texte: 'La rémunération de l\'apprenti, régie par l\'article 25, prend la forme d\'une indemnité, non d\'un salaire ordinaire, mais une indemnité fortement encadrée : fixée par arrêté ministériel après avis du Conseil National du Travail, elle doit être majorée au fur et à mesure des années d\'apprentissage, et toutes les obligations et garanties du Code en matière de salaire, notamment celles étudiées au chapitre 5 sur la protection du salaire, s\'y attachent intégralement.' },
      { type: 'paragraphe', texte: 'L\'article 27 permet enfin d\'assortir le contrat d\'une clause de fidélité : l\'apprenti peut s\'engager à travailler pour son ancien maître, après l\'apprentissage, pendant une période ne pouvant excéder deux ans. L\'inobservation de cet engagement, par l\'une ou l\'autre partie, ouvre droit à des dommages-intérêts et impose la prestation d\'un préavis ou, à défaut, le versement d\'une indemnité compensatoire, calculée selon les règles applicables à la rupture du contrat de travail, étudiées au chapitre 4.' },
    ],
  },
  {
    numero: '2.6',
    titre: 'Suspension, fin du contrat et mesures de contrôle',
    navLabel: 'Suspension et fin du contrat',
    blocs: [
      { type: 'paragraphe', texte: 'Le contrat d\'apprentissage se suspend, selon l\'article 28, pendant la durée de l\'incapacité de travail de l\'apprenti résultant de maladie ou d\'accident. Le maître ne recouvre une faculté de résiliation qu\'après six mois d\'incapacité, ou lorsque la situation médicale fait présumer une incapacité continue de six mois, à l\'exclusion du cas particulier de l\'accident du travail ou de la maladie professionnelle.' },
      { type: 'paragraphe', texte: 'D\'autres causes mettent fin au contrat de plein droit, sans qu\'aucune partie n\'ait à en décider : mort du maître ou de l\'apprenti, appel ou rappel sous le drapeau, condamnation du maître à une peine de servitude pénale supérieure à trois mois sans sursis, ou, pour les apprenties mineures hébergées chez le maître, divorce de celui-ci ou décès de l\'épouse ou de la femme qui dirigeait la maison. L\'article 30 organise, à côté de ces causes automatiques, une résiliation à la demande des parties, pour manquement contractuel, infraction grave ou habituelle aux obligations des articles 24 ou 26, déménagement du maître hors de son entité administrative, condamnation pénale de plus de deux mois, ou mariage de l\'apprenti.' },
      { type: 'filet', titre: 'Protection renforcée du mineur', texte: 'Lorsque l\'apprenti est mineur, toute résiliation à l\'initiative du maître est soumise à la condition suspensive de son approbation par l\'Inspecteur du Travail du ressort, qui doit statuer dans le mois, son silence valant approbation. Cette procédure prolonge, au stade de la rupture, la même logique protectrice qui encadrait déjà l\'entrée en apprentissage à l\'article 6, étudié au chapitre 1.' },
      { type: 'paragraphe', texte: 'Le contrôle de l\'exécution du contrat d\'apprentissage relève de l\'Inspecteur du Travail du ressort, qui peut se faire assister d\'un technicien pour contrôler l\'enseignement dispensé, toute cessation devant être portée à sa connaissance ainsi qu\'à celle de l\'Office National de l\'Emploi. Enfin, l\'article 34 clôt le Titre III par un principe d\'assimilation générale : les apprentis sont assimilés aux travailleurs et bénéficient de toutes les autres dispositions du Code qui ne sont pas contraires aux règles particulières de ce Titre, ce qui rattache pleinement l\'apprentissage à l\'architecture protectrice étudiée depuis le chapitre 1.' },
    ],
  },
]
...
export const chapitre: Chapitre = {
  ...
  sousTitre: 'Titres II et III du Code du travail · Loi n°015/2002, art. 8 à 35',
  infoBulle: 'Obligation de formation, statut de l\'INPP, contrat d\'apprentissage.',
  loiRef: 'Titres II-III, art. 8 à 35',
  ...
  references: [
    {
        genre: "texte",
        intitule: "Arrêté interministériel du 14 février 2006 fixant le taux de la cotisation INPP",
        precision: "Journal officiel de la RDC, 1ʳᵉ partie n°6, 15 mars 2006 (abrogé)"
    },
    {
        genre: "texte",
        intitule: "Arrêté interministériel du 24 septembre 2025 fixant le taux de la cotisation INPP (en vigueur)"
    },
    {
        genre: "texte",
        intitule: "Ordonnance-loi n°206 du 29 juin 1964 portant création de l'Institut National de Préparation Professionnelle"
    },
    {
        genre: "texte",
        intitule: "Office National de l'Emploi, communiqué relatif au partenariat ANEP-INPP du 23 décembre 2025"
    }
],
  qcm: QCM,
  casPratiques: CAS,
  sources: 'Sources : Loi n°015/2002 du 16 octobre 2002 portant Code du travail, art. 8 à 35 · Loi n°16/010 du 15 juillet 2016 · Arrêté interministériel du 24 septembre 2025 (cotisation INPP)',
}
