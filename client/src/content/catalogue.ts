...
export const CATALOGUE: Record<string, Record<number, ChargeurChapitre>> = {
  ...
  ue3: {
    ...
    2: () => import('./ue3/chapitre-2'),
    3: () => import('./ue3/chapitre-3'),
    4: () => import('./ue3/chapitre-4'),
    5: () => import('./ue3/chapitre-5'),
    6: () => import('./ue3/chapitre-6'),
    7: () => import('./ue3/chapitre-7'),
    8: () => import('./ue3/chapitre-8'),
    9: () => import('./ue3/chapitre-9'),
    10: () => import('./ue3/chapitre-10'),
  },
  ue5: {
  ...
  ue13: {
    ...
    2: () => import('./ue13/chapitre-2'),
    3: () => import('./ue13/chapitre-3'),
    4: () => import('./ue13/chapitre-4'),
    5: () => import('./ue13/chapitre-5'),
    6: () => import('./ue13/chapitre-6'),
    7: () => import('./ue13/chapitre-7'),
    8: () => import('./ue13/chapitre-8'),
  },
}
