...
export const TERMES_AUDIT: TermeDict[] = [
  ...
  },
  {
    ...
    voirAussi: ['seuil-signification-isa320', 'opinion-non-modifiee-isa700'],
  },
  {
    id: 'opinion-non-modifiee-isa700',
    terme: 'Opinion non modifiée (ISA 700)',
    domaine: 'audit',
    ues: ['ue12-audit'],
    definition: "L'auditeur doit exprimer une opinion non modifiée lorsqu'il conclut que les états financiers ont été préparés, dans tous leurs aspects significatifs, conformément au référentiel d'information financière applicable. C'est la forme d'opinion attendue à l'issue d'un audit sans réserve, à distinguer des opinions modifiées (avec réserve, défavorable, impossibilité d'exprimer une opinion) régies par l'ISA 705.",
    source: 'ISA 700 (révisée), §16',
    voirAussi: ['opinion-avec-reserve-isa705'],
  },
  {
    id: 'fraude-isa240',
    terme: 'Fraude (ISA 240)',
    domaine: 'audit',
    ues: ['ue12-audit'],
    definition: "Acte intentionnel commis par une ou plusieurs personnes parmi les membres de la direction, les responsables de la gouvernance, les employés ou des tiers, impliquant le recours à des manœuvres trompeuses dans le but d'obtenir un avantage indu ou illégal. Un « facteur de risque de fraude » est un événement ou une circonstance qui indique l'existence de motifs ou de pressions pouvant susciter la perpétration d'une fraude, ou qui offre l'occasion de la commettre. La fraude se distingue de l'erreur par le caractère intentionnel de l'acte.",
    source: 'ISA 240, §12',
    voirAussi: ['esprit-critique-isa200'],
  },
  {
    id: 'assertions-isa315',
    terme: 'Assertions (ISA 315)',
    domaine: 'audit',
    ues: ['ue12-audit'],
    definition: "Affirmations que formule la direction, explicitement ou non, concernant la comptabilisation, l'évaluation, la présentation et la fourniture d'informations dans les états financiers lorsqu'elle déclare que ceux-ci ont été préparés conformément au référentiel d'information financière applicable. Lorsqu'il identifie et évalue les risques d'anomalies significatives et qu'il y répond, l'auditeur se réfère aux assertions pour examiner les différents types d'anomalies susceptibles de se produire.",
    source: 'ISA 315 (révisée en 2019), §12(a)',
    voirAussi: ['risque-audit-isa200'],
  },
]
