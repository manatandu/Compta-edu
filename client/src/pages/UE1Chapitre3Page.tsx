...
// ─────────────────────────────────────────────────────────────────────────────
// IDENTITÉ VISUELLE — reprise à l'identique des chapitres 1-2.
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// CAS PRATIQUES — 5 situations à plusieurs strates, art. 36 à 60 uniquement.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function UE1Chapitre3Page() {
    ...
    <div ref={sommetRef} className="space-y-4 pb-10 animate-fadeIn">
      ...
      <div className="space-y-1">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <h1 className={cn('font-display text-lg font-bold leading-tight', ENCRE)}>Le contrat de travail : formation, exécution, suspension</h1>
          <InfoTooltip texte="Formation, durée, forme, obligations réciproques et suspension du contrat de travail." loi="Titre IV (1/2), art. 36 à 60" />
        </div>
        <p className="text-xs font-mono uppercase tracking-wide text-muted-foreground">Titre IV du Code du travail (chapitres I à V) · Loi n°015/2002, art. 36 à 60</p>
      </div>
        ...
        <div className="grid gap-0 lg:grid-cols-[180px_1fr] lg:gap-10">
          <nav className="hidden lg:block">
            <div className="sticky top-4 space-y-1 pt-2">
              ...
              {[
                ['s1', '3.1 Dispositions générales'],
                ['s2', '3.2 Durée et clause d\'essai'],
                ['s3', '3.3 Forme et preuve'],
                ['s4', '3.4 Obligations du travailleur'],
                ['s5', "3.5 Obligations de l'employeur"],
                ['s6', '3.6 La suspension du contrat'],
              ].map(([id, label]) => (
          ...
          <div className="min-w-0 space-y-14">
            ...
            <section id="s1" className="scroll-mt-16">
              <div className="flex items-baseline gap-3 mb-4">
                <span className={cn('font-serif font-bold text-sm', VERT)}>3.1</span>
                <h2 className={cn('font-serif font-bold text-xl', ENCRE)}>Dispositions générales : liberté contractuelle et ordre public</h2>
              </div>
              <div className={cn('space-y-4 text-[15px] leading-[1.75]', ENCRE)}>
                <p className={LETTRINE}>Le Titre IV s'ouvre sur un principe que le chapitre 1 a déjà annoncé : les contrats de travail sont passés librement, sous réserve des dispositions du Code. L'article 36 laisse aux parties le soin de fixer la date d'entrée en vigueur, la durée, la nature et l'objet des prestations, le lieu d'exécution, la rémunération et les avantages complémentaires, dans le cadre des dispositions légales et sous réserve des conventions collectives, règlements d'entreprise et usages locaux. Le contrat peut toujours mentionner des conditions plus favorables au travailleur, prolongement direct du principe de faveur étudié au chapitre 1.</p>
                <p>Cette liberté contractuelle rencontre cependant une limite immédiate et impérative à l'article 37 : les contrats de travail ne peuvent déroger aux dispositions d'ordre public de la législation et de la réglementation en vigueur, et toute clause accordant au travailleur des avantages inférieurs à ceux du Code est nulle de plein droit. Cette nullité automatique, sans intervention judiciaire préalable, illustre le caractère d'ordre public social déjà rencontré à propos de la finalité protectrice du droit du travail.</p>
                <div className={cn('rounded-sm border-l-[3px] pl-4 py-1 my-2', VERT_BORDER)}>
                  <p className={cn('text-[10px] font-mono uppercase tracking-wider mb-1', VERT)}>L'aptitude médicale, condition d'exécution</p>
                  <p className={cn('text-xs italic', ENCRE_DOUX)}>L'article 38 subordonne l'exécution du contrat à la constatation de l'aptitude au travail par certificat médical. Une personne médicalement inapte au travail auquel elle est destinée ne peut être ni engagée ni maintenue en service : cette règle, souvent négligée en pratique, engage la responsabilité de l'employeur qui ne l'observe pas.</p>
                </div>
              </div>
            </section>
            ...
            <section id="s2" className="scroll-mt-16">
              <div className="flex items-baseline gap-3 mb-4">
                <span className={cn('font-serif font-bold text-sm', VERT)}>3.2</span>
                <h2 className={cn('font-serif font-bold text-xl', ENCRE)}>Durée du contrat et clause d'essai</h2>
              </div>
              <div className={cn('space-y-4 text-[15px] leading-[1.75]', ENCRE)}>
                <p className={LETTRINE}>L'article 39 pose une distinction binaire : tout contrat de travail est à durée déterminée ou à durée indéterminée. Le contrat à durée déterminée, défini à l'article 40, couvre trois hypothèses seulement : un temps déterminé, un ouvrage déterminé, ou le remplacement d'un travailleur temporairement indisponible. L'article 41 encadre étroitement ce type de contrat : deux ans au plus, réduits à un an pour le travailleur marié séparé de sa famille ou veuf, séparé de corps ou divorcé séparé de ses enfants ; deux contrats au maximum avec le même employeur, un seul renouvellement, sauf exceptions par arrêté ministériel pour les travaux saisonniers ou ouvrages bien définis.</p>
                <p>La sanction de ces limites est automatique : tout contrat conclu en violation de l'article 41, ou toute continuation de service hors des cas prévus, constitue de plein droit l'exécution d'un contrat à durée indéterminée. L'article 42 y ajoute une règle distincte, fondée non sur le nombre de contrats mais sur la nature de l'emploi : lorsque le travailleur occupe un emploi permanent, le contrat doit être à durée indéterminée dès l'origine, sous la même sanction de requalification automatique. Pimant relève, à propos de cette requalification, qu'elle est fréquemment mal anticipée par les employeurs congolais, qui perçoivent le contrat à durée déterminée comme un outil de flexibilité sans mesurer les limites strictes que le Code lui impose.</p>
                <div className={cn('rounded-sm p-4 border', LIGNE_FORTE, PAPIER_CARD)}>
                  <p className={cn('text-[10px] font-mono uppercase tracking-wider mb-2', ENCRE_FAIBLE)}>Article 43, synthèse des plafonds de la clause d'essai</p>
                  <table className="w-full text-xs border-collapse mt-2">
                    <thead><tr className={VERT_SOFT}><th className={cn('text-left p-2 border font-semibold', LIGNE)}>Catégorie</th><th className={cn('text-left p-2 border font-semibold', LIGNE)}>Durée maximale</th></tr></thead>
                    <tbody>
                      <tr className="even:bg-black/[.02]"><td className={cn('p-2 border', LIGNE)}>Manœuvre sans spécialité</td><td className={cn('p-2 border font-semibold', LIGNE, VERT)}>Un mois</td></tr>
                      <tr className="even:bg-black/[.02]"><td className={cn('p-2 border', LIGNE)}>Autres travailleurs</td><td className={cn('p-2 border font-semibold', LIGNE, VERT)}>Six mois</td></tr>
                    </tbody>
                  </table>
                  <p className={cn('text-xs mt-2', ENCRE_DOUX)}>Une clause d'essai excédant ces plafonds n'est pas nulle : elle est réduite de plein droit à la durée maximale applicable. La prolongation des services au-delà de cette durée entraîne automatiquement la confirmation du contrat.</p>
                </div>
              </div>
            </section>
            ...
            <section id="s4" className="scroll-mt-16">
              <div className="flex items-baseline gap-3 mb-4">
                <span className={cn('font-serif font-bold text-sm', VERT)}>3.4</span>
                <h2 className={cn('font-serif font-bold text-xl', ENCRE)}>Les obligations du travailleur</h2>
              </div>
              <div className={cn('space-y-4 text-[15px] leading-[1.75]', ENCRE)}>
                <p className={LETTRINE}>Les articles 50 à 52 dessinent le socle des obligations du travailleur : exécuter personnellement son travail dans les conditions convenues, agir conformément aux ordres reçus, respecter les règlements de l'établissement, s'abstenir de tout ce qui pourrait nuire à sa sécurité ou à celle d'autrui, respecter les convenances et bonnes mœurs, traiter avec équité les travailleurs placés sous ses ordres, restituer en bon état ce qui lui a été confié, et garder les secrets de fabrication ou d'affaires, y compris après l'expiration du contrat.</p>
                <p>C'est à cette dernière obligation de discrétion que se rattache la clause de non-concurrence, régie par l'article 53, l'une des dispositions les plus doctrinalement discutées du Titre IV. Le principe posé est celui de la nullité : est nulle de plein droit toute clause interdisant au travailleur, après la fin du contrat, d'exploiter une entreprise personnelle, de s'associer ou de s'engager chez un autre employeur. Muanda souligne que cette nullité de principe traduit un arbitrage du législateur en faveur de la liberté du travail, garantie constitutionnelle, contre une pratique contractuelle que les employeurs tendent à généraliser par leur seule volonté.</p>
                <div className={cn('rounded-sm p-4 border', LIGNE_FORTE, PAPIER_CARD)}>
                  <p className={cn('text-[10px] font-mono uppercase tracking-wider mb-2', ENCRE_FAIBLE)}>Article 53, conditions cumulatives de l'exception</p>
                  <ul className={cn('text-xs space-y-1.5 list-disc list-inside', ENCRE_DOUX)}>
                    <li>La rupture résulte d'une faute lourde du travailleur, <b>ou</b> le travailleur a lui-même mis fin au contrat sans faute lourde de l'employeur</li>
                    <li>Le travailleur a, de la clientèle ou des secrets d'affaires, une connaissance telle qu'il puisse nuire gravement à l'employeur</li>
                    <li>L'interdiction se rapporte aux activités que le travailleur exerçait chez l'employeur</li>
                    <li>La durée de l'interdiction ne dépasse pas un an à compter de la fin du contrat</li>
                  </ul>
                  <p className={cn('text-xs mt-2', ENCRE_DOUX)}>Un licenciement à l'initiative de l'employeur, non fondé sur une faute lourde du travailleur, notamment un licenciement économique, laisse la clause frappée de la nullité de principe : elle ne bascule dans aucune des deux hypothèses d'exception.</p>
                </div>
                <p>L'article 54 clôt cette section par l'échelle des sanctions disciplinaires que le travailleur encourt en cas de manquement : blâme, réprimande, mise à pied dans les limites de l'article 57 point 5, licenciement avec préavis, licenciement sans préavis dans les cas des articles 72 et 74, étudiés au chapitre 4. La sanction doit être proportionnée à la gravité, à la répétition de la faute ou à l'intention de nuire qui l'a inspirée.</p>
              </div>
            ...
            <section id="s5" className="scroll-mt-16">
              <div className="flex items-baseline gap-3 mb-4">
                <span className={cn('font-serif font-bold text-sm', VERT)}>3.5</span>
                <h2 className={cn('font-serif font-bold text-xl', ENCRE)}>Les obligations de l'employeur</h2>
              </div>
              <div className={cn('space-y-4 text-[15px] leading-[1.75]', ENCRE)}>
                <p className={LETTRINE}>L'article 55 impose symétriquement à l'employeur de fournir au travailleur l'emploi convenu, dans les conditions, au temps et au lieu convenus, de diriger le travailleur et de veiller à ce que le travail s'accomplisse dans des conditions convenables du point de vue de la sécurité, de la santé et de la dignité. L'employeur répond de l'exécution du contrat passé par toute personne agissant en son nom, une règle de représentation qui prolonge la logique de délégation déjà rencontrée à propos de la mise à disposition de personnel au chapitre 1.</p>
                <p>Une obligation plus concrète, souvent source de contentieux en pratique, figure à l'article 56 : l'employeur supporte la charge du transport des travailleurs entre leur résidence et leur lieu de travail, à partir d'une distance fixée par arrêté ministériel. Cette obligation, distincte de la rémunération proprement dite étudiée au chapitre 5, illustre que les obligations de l'employeur ne se limitent pas au seul versement du salaire.</p>
              </div>
            </section>
            ...
            <div className="pt-6 border-t border-[#D9CFA9]">
              ...
              <ul className="space-y-0">
                {[
                  <>Pimant C., « Du contrat à durée déterminée et sa requalification en contrat à durée indéterminée en droit du travail congolais », <i>Village Justice</i>, note professionnelle en ligne.</>,
                  <>Muanda D. J., « La clause de non-concurrence dans l'espace OHADA : cas de la RDC », <i>Legavox</i>, note professionnelle en ligne.</>,
            ...
            <button onClick={goBack} className={cn('w-full flex items-center justify-center gap-2 py-3 rounded-sm text-white text-sm font-semibold transition-colors', VERT_BG)}>
              <GraduationCap className="h-4 w-4" /> Terminer le chapitre 3
            </button>

            <p className="text-xs text-center text-muted-foreground/60 pb-2">
              Sources : Loi n°015/2002 du 16 octobre 2002 portant Code du travail, art. 36 à 60 · Loi n°16/010 du 15 juillet 2016
            </p>
          </div>
        </div>
      )}
      ...
      {vue === 'devoir' && !isStudent && (
        <div className="space-y-4">
          ...
          <DevoirChapitreCreateur
            chapitreId="ue1-chapitre-3"
            chapitreNom="Chapitre 3 : Le contrat de travail (formation, exécution, suspension)"
